...
int nworkers = 20;   // number of workers (default use all available cores)

/////////////////////////////////////////////////////////////////////////

pair<double,double> TwoSidedFrequentistUpperLimitWithBands(const char* infile = "",
					    RooWorkspace* w = NULL,
  ...
  double additionalToysFac = 0.5; //.5;
  int nPointsToScan = 20; //20; // number of steps in the parameter of interest
  ...
  //  firstPOI->setMin(0);
   firstPOI->setMax(firstPOI->getVal()+4.*firstPOI->getErrorHi());
  ...
  RooDataSet* sampds = toymcsampler->GenerateToyData(*tmpPoint);
  cout << ".........................................................." << endl;
  sampds->Print();
  cout << ".........................................................." << endl;
  sampPlot.AddSamplingDistribution(samp);
  TCanvas *csamp = new TCanvas(); csamp->cd();
  sampPlot.Draw();
  ...
  result.first = interval->LowerLimit(*firstPOI);
  result.second = interval->UpperLimit(*firstPOI);
