...
for i in `seq 0 100`; do
   ...
   # nice root -l -b -q /home/llr/cms/chapon/data_CMS/upsilon/effs/doEff.C'("/home/llr/cms/chapon/data_CMS/upsilon/effs/trees/Upsi_Histos_ppNoCutMC3S_ok.root",3,false,2,2,'$i')' >/dev/null &
   cd -
done
